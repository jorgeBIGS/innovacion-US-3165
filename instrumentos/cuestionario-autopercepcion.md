...
5. ¿Con qué frecuencia usas IA generativa para tareas académicas? Nunca / Alguna vez al
   mes / Alguna vez a la semana / Casi a diario.

## Bloque B. Competencia percibida

*Instrucción:* indica hasta qué punto te ves capaz de hacer cada cosa. Escala de 1
(*nada capaz*) a 5 (*totalmente capaz*). No hay respuestas correctas ni incorrectas.

**D1. Conocer y entender**

1. Explicar con mis palabras cómo genera texto un sistema de IA generativa.
2. Explicar por qué estos sistemas a veces producen información falsa.
3. Distinguir las tareas en las que estos sistemas son fiables de aquellas en las que no.
4. Reconocer que una misma petición puede dar respuestas distintas.

**D2. Usar y aplicar**

5. Formular una petición con el contexto y el objetivo que necesita.
6. Pedir ayuda que me haga aprender, en lugar de pedir la solución.
7. Reformular mi petición cuando la respuesta no me sirve.
8. Decidir cuándo no debo usar la IA en una tarea.

**D3. Evaluar y crear**

9. Comprobar si lo que responde es correcto, con fuentes de mi disciplina.
10. Detectar errores, omisiones o referencias inventadas.
11. Identificar supuestos que la respuesta da por hechos y yo no había fijado.
12. Reelaborar lo que me devuelve hasta convertirlo en un trabajo mío.

**D4. Cuestiones éticas**

13. Declarar con claridad en qué he usado la IA en un trabajo.
14. Distinguir un uso legítimo de un caso de fraude académico.
15. Decidir qué información no debo introducir en estos sistemas.
16. Valorar los riesgos del uso de la IA en el ámbito profesional de mi titulación.

> La puntuación se analiza por dimensión (media de sus cuatro ítems) y en total. Los ítems
...
17. ¿En cuáles de estas tareas has usado IA generativa este cuatrimestre? *(varias
    ...
    Resumir bibliografía · Preparar exámenes · Otra.
18. Cuando la usas, ¿qué sueles pedirle? La solución · Ayuda para llegar yo a la solución ·
    Depende de la tarea.
...
Descripción de las distribuciones —tendencia central, dispersión y forma— y contraste
pre/post. La comparación entre disciplinas es descriptiva. Todo agregado; nunca resultados
individuales.
